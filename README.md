...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 69; position: fixed; left: 50dvi; top: 0; background-position: 0 0; translate: -50% 0%; opacity: 0.5; background-repeat: no-repeat; transform: scaleY(-1); background-size: 100% 100%; height: 228px; width: 10000px; animation: 5s linear both alternate-reverse infinite rotate; background: url('https://github.com/PickleNik/picklenik/blob/main/parrot-party.gif?raw=true');]{x0000}$}
