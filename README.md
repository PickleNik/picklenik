...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 69; position: fixed; left: 100dvi; bottom: -1rem; background-position: 0 0; translate: -50% 0%; opacity: 0.5; background-repeat: no-repeat; background-size: contain; height: 100px; width: 10000px; animation: 50s linear both alternate-reverse infinite shrink-x; background: url('https://github.com/PickleNik/picklenik/blob/main/amogus.webp?raw=true');]{x0000}$}
