...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -69; position: fixed; bottom: -2rem; left: 0; height: 100vh; width: 100vw; opacity: 1; background: url('https://github.com/PickleNik/picklenik/blob/main/xp.webp?raw=true') no-repeat; background-size: contain; background-position: bottom center !important; ]{x0000}$}

```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 420; position: fixed; bottom: -2rem; left: 0; height: 100vh; width: 100vw; opacity: 1; background: url('https://github.com/PickleNik/picklenik/blob/main/xpfg.png?raw=true') no-repeat; background-size: contain; background-position: bottom center !important; ]{x0000}$}
