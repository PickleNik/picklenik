...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -69; position: fixed; top: 0; left: 0; height: 30vmin; width: 30vmin; object-fit: cover; opacity: 1; border-radius: 100%; background:linear-gradient(#f8f, #ff8);]{x0000}$}
