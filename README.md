...
```math
\ce{$\unicode[goombafont; transform: rotate(69420deg); transition: all 5s linear; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 0.5; background: linear-gradient(to right, red, orange, yellow, green, blue, purple);]{x0000}$}
