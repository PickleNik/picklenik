...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 69; position: fixed; left: 50dvi; top: 50dvi; transform:scaleX(-1); background-position: 5000px 0; object-fit: contain; translate: -50% -50%; opacity: 0.5; background-size: contain; height: 100vh; width: 100000px; animation: 50s linear both infinite shrink-x; background-image: url('https://github.com/PickleNik/picklenik/blob/main/amogus.webp?raw=true');]{x0000}$}
