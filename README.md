...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 420; position: fixed; bottom: -2rem; left: 0; height: 120vh; width: 100vw; opacity: 0.8; background: url('https://github.com/PickleNik/picklenik/blob/main/xpfg.png?raw=true') no-repeat; background-size: 100% 100vh; background-position: bottom center !important; ]{x0000}$}
