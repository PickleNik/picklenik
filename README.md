...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -69; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; object-fit: cover; opacity: 1; background: url('xp.webp?raw=true') contain no-repeat; ]{x0000}$}

```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 420; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; object-fit: cover; opacity: 1; background: url('xpfg.png?raw=true') contain no-repeat; opacity:0.3; ]{x0000}$}
