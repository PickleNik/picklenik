...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -69; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; object-fit: cover; opacity: 1; background: url('https://github.com/PickleNik/picklenik/blob/main/xp.webp?raw=true') no-repeat; background-size: cover; ]{x0000}$}

```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 420; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; object-fit: cover; opacity: 1; background: url('https://github.com/PickleNik/picklenik/blob/main/xpfg.png?raw=true') no-repeat; background-size: cover; ]{x0000}$}
