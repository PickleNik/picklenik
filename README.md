...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: 40px 40px; background-position: -19px -19px; width: 130vw; opacity: 0.5; background:radial-gradient(#f8f 1px, transparent 0);]{x0000}$}
